...
export default class StackTransitioner extends Component {
    constructor() {
        ...
        this.isHorizontal = animationType => animationType.indexOf('horizontal') > -1 || animationType === 'cube';
        ...
        this.cancelNavigation = duration => {
        ...
        this.finishNavigation = duration => {
        ...
        this.getChildren = (currentLocation, previousLocation) => {
        ...
        this.getDimension = () => {
            return getDimension(this.state.routeAnimationType || this.props.animationType, this.props.width, this.props.height);
        };
        this.getRouteStyle = index => {
            ...
            return [
                styles.stackView,
                stackViewStyle,
                getTransforms(width, height, animatedValue, routeAnimationType || animationType, transitionType, index),
            ];
        };
    }
    componentWillReceiveProps(nextProps) {
        ...
        const routeAnimationType = action === PUSH ? (children && children.props.animationType) : (previousChildren && previousChildren.props.animationType);
        this.setState({
    ...
    isFixed(element) {
        ...
        if (!children.props[`${element}Component`])
            return false; // current route has no headerComponent or footerComponent
        if (!previousChildren)
            return true; // inital app render
    ...
    render() {
        ...
        let routes = [];
        if (transition === PUSH) {
            previousChildren && routes.push(key, { previousChildren, : .key }, style = { this: .getRouteStyle(0) } >
                {}(!this.isFixed("footer") && PreviousFooter) && animatedValue, { this: .animatedValue } /  > );
        }
        {
            previousChildren;
        }
        {
            (!this.isFixed("header") && PreviousHeader) && animatedValue;
            {
                this.animatedValue;
            }
            />}
                < /Animated.View>;
            ;
            children && routes.push(key, { children, : .key }, style = { this: .getRouteStyle(1) } >
        ...
        {
            (!this.isFixed("header") && Header) && animatedValue;
            {
                this.animatedValue;
            }
            />}
        ...
        if (transition === POP || this.isPanning) {
            children && routes.push(key, { children, : .key }, style = { this: .getRouteStyle(0) } >
                {}(!this.isFixed("footer") && Footer) && animatedValue, { this: .animatedValue } /  > );
        }
        {
            children;
        }
        {
            ...
            />}
                < /Animated.View>;
            ;
            previousChildren && routes.push(key, { previousChildren, : .key }, style = { this: .getRouteStyle(1) } >
                {}(!this.isFixed("footer") && PreviousFooter) && animatedValue, { this: .animatedValue } /  > );
        }
        {
            previousChildren;
        ...
        {
            children && routes.push(key, { children, : .key }, style = { [styles.stackView, stackViewStyle]:  } >
                {}(!this.isFixed("footer") && Footer) && animatedValue, { this: .animatedValue } /  > );
        }
        {
            children;
        ...
        return key = "stack-view";
        style = { [styles.stackView, stackViewStyle]:  };
        {
            this.panResponder.panHandlers;
        }
         >
            { this: .isFixed("footer") && animatedValue };
        {
            this.animatedValue;
        }
        />}
        ...
        style = { styles, : .transitionContainer } >
            ...
            < /View>;
        {
            this.isFixed("header") && animatedValue;
            {
                this.animatedValue;
            }
            />}
